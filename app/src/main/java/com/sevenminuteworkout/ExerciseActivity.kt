    ...
    private fun setRestProgressBar() {
        ...
        restTimer = object : CountDownTimer(restTimeDuration*1000, 1000) {
            override fun onTick(millisUntilFinished: Long) {
                ...
                progressBar.progress = restTimeDuration.toInt() - restProgress // Indicates progress bar progress
                tvTimer.text =
                        (restTimeDuration - restProgress).toString()  // Current progress is set to text view in terms of seconds.
            }
